# Contributing to chronon-valence-identity

Thank you for improving this crate.

## Development setup

1. Clone [unified-field-dev/chronon-valence-identity](https://github.com/unified-field-dev/chronon-valence-identity)
